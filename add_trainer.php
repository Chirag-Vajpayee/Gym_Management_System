...
<div class="container trainit">
  <form class="mt-3 form-group" method="post" action="">
    ...
    <div> <input type="text" name="id" class="form-control trainer">
    </div>
    <label class="mt-3">TRAINER NAME</label>
    <div> <input type="text" name="name" class="form-control trainer">
    </div>
    <label class="mt-3">TIME</label>
    <div> <input type="text" name="time" class="form-control trainer">
    </div>
    <label class="mt-3">MOBILE NO</label>
    <div>
      <input type="text" name="mobileno" class="form-control trainer">

    </div>
    <label class="mt-3">PAYMENT AREA ID</label>
    <div> <input type="text" name="pay_id" class="form-control trainer">
    </div>
